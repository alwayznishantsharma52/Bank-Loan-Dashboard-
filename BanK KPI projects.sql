...
select count(id) As Total_Loan_Application from bank_loan_data ; -- 38576

SELECT COUNT(id) AS Total_Applications FROM bank_loan_data
WHERE MONTH(issue_date) = 12 ; -- 4314

-- PMTD
SELECT COUNT(id) AS Total_Applications FROM bank_loan_data
WHERE MONTH(issue_date) = 11; -- 4035


-- Total Funded Amount
SELECT SUM(loan_amount) AS Total_Funded_Amount FROM bank_loan_data; -- 435757075
...
-- LOAN STATUS
    ...
    FROM
        bank_loan_data
    GROUP BY
        loan_status; -- Charged Off	5333	37284763	65532225	13.878574910931917	14.004732795799695
